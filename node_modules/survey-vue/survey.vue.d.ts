...
export declare class SurveyElementVue extends Vue {
    ...
    getRootClass(element: Question): string;
    getContentClass(element: Question): any;
...
export declare class PanelDynamicProgress extends Vue {
    ...
    getButtonAddCss(question: Question): void;
    getButtonPrevCss(question: Question): any;
...
export declare class Image extends Vue {
...
export declare class Custom extends QuestionVue<QuestionCustomModel> {
    readonly contentQuestion: import("../question").Question;
}


export declare class Composite extends QuestionVue<QuestionCompositeModel> {
    readonly contentPanel: import("../panel").PanelModel;
}
